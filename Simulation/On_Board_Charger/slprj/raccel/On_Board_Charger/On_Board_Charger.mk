...
MODULES                 = rt_matrx.c rt_printf.c On_Board_Charger.c On_Board_Charger_capi.c On_Board_Charger_data.c On_Board_Charger_tgtconn.c rtGetInf.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT                 = On_Board_Charger
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/home/srikar/MATLAB/R2024b/sys/os/glnxa64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/On_Board_Charger \
