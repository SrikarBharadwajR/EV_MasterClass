...
MAKECMD         = /home/srikar/MATLAB/R2024b/bin/glnxa64/gmake -j 4 -l 4
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = On_Board_Charger
MODULES                 = On_Board_Charger_acc.c On_Board_Charger_acc_data.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/On_Board_Charger_acc.mexa64
MAKEFILE                = On_Board_Charger.mk
MATLAB_ROOT             = /home/srikar/MATLAB/R2024b
ALT_MATLAB_ROOT         = /home/srikar/MATLAB/R2024b
START_DIR               = /mnt/Storage/Projects/EV_MasterClass
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 17
COMPUTER                = GLNXA64
...
SYSTEM_LIBS             = -L"/home/srikar/MATLAB/R2024b/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = On_Board_Charger_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/On_Board_Charger \
...
On_Board_Charger_acc.o : $(START_DIR)/slprj/accel/On_Board_Charger/On_Board_Charger_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/On_Board_Charger/On_Board_Charger_acc.c

On_Board_Charger_acc_data.o : $(START_DIR)/slprj/accel/On_Board_Charger/On_Board_Charger_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/On_Board_Charger/On_Board_Charger_acc_data.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/On_Board_Charger/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/On_Board_Charger/rt_nonfinite.c
